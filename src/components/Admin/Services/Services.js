...
export default function Service_admin() {
    ...
    function getDatas() {
        axios.get(`${global.config.apiUrl}service`).then(function(response) {
    ...
    const deleteUser = (id) => {
        axios.delete(`${global.config.apiUrl}service/delete/${id}`).then(function(response){
            getDatas();
        });
    }
    ...
    const handleSubmit = (event) => {
        ...
        axios.post(`${global.config.apiUrl}service/create`, inputs).then(function(response){
    ...
    //     document.getElementById('modelbutton').click();
    //     axios.get(`http://localhost/react_admin/crud/single_services.php?id=${id}`).then(function(response) {
    ...
    return (
        ...
        <div className="container">
            ...
            <Sidebar/>
                <div className="col-9">
                        <h1 className="text-center"><small>Services List</small></h1>
                ...
                <div className="modal-dialog modal-lg">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h4 className="modal-title">Services Data</h4>
